...
const social_activities = () => {
  ...
  formData.append("category", "social_activities");
  ...
  try {
    ...
    Alert.alert(
      ...
      [
        {
          text: "OK",
          onPress: () => navigation.navigate("socialactivities"), // 👈 navigate after success
        },
      ]
    );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("socialactivities")}
        >
